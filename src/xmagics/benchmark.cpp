...
namespace xcpp
{
    xoptions benchmark::get_options()
    {
        xoptions options{"benchmark", "write executable"};
        options.add_options()
            ("f,filename", "filename",
    ...
    std::string benchmark::generate_fns(const std::string& cell,
                                         std::string& main,
    ...
    bool benchmark::generate_obj(std::string& ObjectFile, bool EnableDebugInfo)
    {
    ...
    bool benchmark::generate_exe(const std::string& ObjectFile,
    ...
    void benchmark::operator()(const std::string& line, const std::string& cell)
    {
