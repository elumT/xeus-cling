...
namespace xcpp
{
    benchmark::benchmark(cling::Interpreter* p)
        : m_interpreter(p)
    {
    ...
    std::string benchmark::inner(std::size_t number, const std::string& code) const
    {
    ...
    std::string benchmark::_format_time(double timespan, std::size_t precision) const
    {
    ...
    void benchmark::execute(std::string& line, std::string& cell)
    {
